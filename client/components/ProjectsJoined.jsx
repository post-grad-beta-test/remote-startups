  ...
  return (
    <Tab title="Projects" icon={<Aggregate />}>
      <Box fill="vertical" overflow="auto" align="center" flex="grow">
        ...
        <DataTable columns={[{ "header": "Name", "property": "name", "primary": true, "sortable": true, "search": true }, { "header": "Dates", "property": "dates", "sortable": true }]} data={[{ "name": "Emma" }, { "name": "Aidan" }]} size="small" onClickRow={[{ "screen": 1, "label": "Screen", "key": 1 }]} pad="medium" />
      </Box>
    </Tab>
  )
}