...
| Column Name | Data Type | Purpose                                |
| ----------- | --------- | -------------------------------------- |
| id          | Integer   | Unique identifier for einterchangeable |
| user_id     | Integer   | Unique identifier for each user        |
| name        | String    | User's name                            |
| description | String    | Description of project                 |
| topic       | String    | Topic of Event                         |
| date_start  | String    | Start date of event                    |
| date_end    | String    | End date of event                      |
| image       | String    | Image for Event                        |
...
| ----------- | --------- | ---------------------------------------- |
| user_id     | Integer   | Unique identifier for each user          |
| project_id  | Integer   | Unique identifier for each project/event |
| team_id     | Integer   | Unique identifier for each project/event |
| user_id     | Integer   | FOREIGN user_id from user table          |
| project_id  | Integer   | FOREIGN project_id from project table    |
